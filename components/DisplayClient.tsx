    ...
    <main className="screen display-screen">
      <div className="display-wrap">
        <div className="display-topline">
          ...
          <button className="sound-btn" onClick={() => setVoiceEnabled(v => !v)} type="button">
        ...
        {latest ? (
          <section className="display-hero">
            <div className="display-label">ÚLTIMO LLAMADO</div>
            <div className="display-number">{latest.visible_number}</div>
            <div className="display-box">Dirigirse al {latest.box}</div>
